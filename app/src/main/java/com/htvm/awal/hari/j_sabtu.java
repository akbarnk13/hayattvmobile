...
public class j_sabtu extends AppCompatActivity {
    public DatabaseReference Dbkoneksi;
    public ListView listviewjadwalminggu;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jsabtu);

        Dbkoneksi = FirebaseDatabase.getInstance().getReference().child("Sabtu");
    ...
    private void readData() {
        ...
        Dbkoneksi.child("Sabtu").orderByChild("jam").addListenerForSingleValueEvent(new ValueEventListener() {
